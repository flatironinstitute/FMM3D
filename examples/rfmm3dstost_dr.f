...
c
        ...
        double precision pot(nsmax)
        double precision fld(3,nsmax)
...
c
        ...
        double precision potex(ntest),fldex(3,ntest)
...
c         and face grid doesn't align
        ...
        call rfmm3dpartstost(ier,iprec,nsource,source,ifcharge,

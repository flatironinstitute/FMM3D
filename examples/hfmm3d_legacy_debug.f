...
c
      ...
      if(ifread.eq.1) then
        open(unit=33,file='matlab/debuginfo1')
        read(33,*) nsource
        read(33,*) ntarg
...
c
        ...
        do i=1,nsource
          read(33,*) source(1,i),source(2,i),source(3,i)
        enddo

        do i=1,ntarg
          read(33,*) targ(1,i),targ(2,i),targ(3,i)
        enddo

        do i=1,nsource
          read(33,*) tmp1,tmp2
          charge(i) = tmp1 + ima*tmp2
        enddo

        do i=1,nsource
          read(33,*) tmp1,tmp2
          dipstr(i) = tmp1 + ima*tmp2
        enddo

        do i=1,nsource
          read(33,*) dipvec(1,i),dipvec(2,i),dipvec(3,i)
        enddo

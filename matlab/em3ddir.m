...
%  See also: EMFMM3D
  ...
  mex_id_ = 'em3ddirect(c i int64_t[x], c i dcomplex[x], c i int64_t[x], c i double[xx], c i int64_t[x], c i dcomplex[xx], c i int64_t[x], c i dcomplex[xx], c i int64_t[x], c i dcomplex[xx], c i int64_t[x], c i double[xx], c i int64_t[x], c io dcomplex[xx], c i int64_t[x], c io dcomplex[xx], c i int64_t[x], c io dcomplex[xx], c i double[x])';

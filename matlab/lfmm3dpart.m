...
if( ntarg == 0 ) 
mex_id_ = 'lfmm3dpartself(c io int64_t[x], c i int64_t[x], c i int64_t[x], c i double[xx], c i int64_t[x], c i dcomplex[], c i int64_t[x], c i dcomplex[], c i double[xx], c i int64_t[x], c io dcomplex[], c i int64_t[x], c io dcomplex[])';
...
mex_id_ = 'lfmm3dparttarg(c io int64_t[x], c i int64_t[x], c i int64_t[x], c i double[xx], c i int64_t[x], c i dcomplex[], c i int64_t[x], c i dcomplex[], c i double[xx], c i int64_t[x], c io dcomplex[], c i int64_t[x], c io dcomplex[], c i int64_t[x], c i double[], c i int64_t[x], c io dcomplex[], c i int64_t[x], c io dcomplex[])';

...
mex_id_ = 'l3dpartdirect(c i int64_t[x], c i double[xx], c i int64_t[x], c i dcomplex[], c i int64_t[x], c i dcomplex[], c i double[xx], c i int64_t[x], c io dcomplex[], c i int64_t[x], c io dcomplex[], c i int64_t[x], c i double[], c i int64_t[x], c io dcomplex[], c i int64_t[x], c io dcomplex[])';

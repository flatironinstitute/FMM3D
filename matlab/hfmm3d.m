  ...
  if(iftarg == 0 || (pgt ~=1 && pgt ~=2)) 
    if(pg == 1)
      if(ifcharge==1 && ifdipole == 0)
        mex_id_ = 'hfmm3dpartstoscp_vec(i int[x], i double[x], i dcomplex[x], i int[x], i double[xx], i dcomplex[xx], io dcomplex[xx])';
[pot] = fmm3d(mex_id_, nd, eps, zk, ns, sources, charges, pot, 1, 1, 1, 1, 3, ns, nd, ns, nd, ns);
      end
      if(ifcharge==0 && ifdipole == 1)
        mex_id_ = 'hfmm3dpartstosdp_vec(i int[x], i double[x], i dcomplex[x], i int[x], i double[xx], i dcomplex[xx], io dcomplex[xx])';
[pot] = fmm3d(mex_id_, nd, eps, zk, ns, sources, dipoles, pot, 1, 1, 1, 1, 3, ns, nd3, ns, nd, ns);
      end
      if(ifcharge==1 && ifdipole == 1)
        mex_id_ = 'hfmm3dpartstoscdp_vec(i int[x], i double[x], i dcomplex[x], i int[x], i double[xx], i dcomplex[xx], i dcomplex[xx], io dcomplex[xx])';
[pot] = fmm3d(mex_id_, nd, eps, zk, ns, sources, charges, dipoles, pot, 1, 1, 1, 1, 3, ns, nd, ns, nd3, ns, nd, ns);
    ...
    if(pg == 2)
      if(ifcharge==1 && ifdipole == 0)
        mex_id_ = 'hfmm3dpartstoscg_vec(i int[x], i double[x], i dcomplex[x], i int[x], i double[xx], i dcomplex[xx], io dcomplex[xx], io dcomplex[xx])';
[pot, grad] = fmm3d(mex_id_, nd, eps, zk, ns, sources, charges, pot, grad, 1, 1, 1, 1, 3, ns, nd, ns, nd, ns, nd3, ns);
      end
      if(ifcharge==0 && ifdipole == 1)
        mex_id_ = 'hfmm3dpartstosdg_vec(i int[x], i double[x], i dcomplex[x], i int[x], i double[xx], i dcomplex[xx], io dcomplex[xx], io dcomplex[xx])';
[pot, grad] = fmm3d(mex_id_, nd, eps, zk, ns, sources, dipoles, pot, grad, 1, 1, 1, 1, 3, ns, nd3, ns, nd, ns, nd3, ns);
      end
      if(ifcharge==1 && ifdipole == 1)
        mex_id_ = 'hfmm3dpartstoscdg_vec(i int[x], i double[x], i dcomplex[x], i int[x], i double[xx], i dcomplex[xx], i dcomplex[xx], io dcomplex[xx], io dcomplex[xx])';
[pot, grad] = fmm3d(mex_id_, nd, eps, zk, ns, sources, charges, dipoles, pot, grad, 1, 1, 1, 1, 3, ns, nd, ns, nd3, ns, nd, ns, nd3, ns);
  ...
  if(iftarg == 1 && pg ~=1 && pg ~=2) 
    if(pgt == 1)
      if(ifcharge==1 && ifdipole == 0)
        mex_id_ = 'hfmm3dpartstotcp_vec(i int[x], i double[x], i dcomplex[x], i int[x], i double[xx], i dcomplex[xx], i int[x], i double[xx], io dcomplex[xx])';
[pottarg] = fmm3d(mex_id_, nd, eps, zk, ns, sources, charges, nt, targ, pottarg, 1, 1, 1, 1, 3, ns, nd, ns, 1, 3, nt, nd, nt);
      end
      if(ifcharge==0 && ifdipole == 1)
        mex_id_ = 'hfmm3dpartstotdp_vec(i int[x], i double[x], i dcomplex[x], i int[x], i double[xx], i dcomplex[xx], i int[x], i double[xx], io dcomplex[xx])';
[pottarg] = fmm3d(mex_id_, nd, eps, zk, ns, sources, dipoles, nt, targ, pottarg, 1, 1, 1, 1, 3, ns, nd3, ns, 1, 3, nt, nd, nt);
      end
      if(ifcharge==1 && ifdipole == 1)
        mex_id_ = 'hfmm3dpartstotcdp_vec(i int[x], i double[x], i dcomplex[x], i int[x], i double[xx], i dcomplex[xx], i dcomplex[xx], i int[x], i double[xx], io dcomplex[xx])';
[pottarg] = fmm3d(mex_id_, nd, eps, zk, ns, sources, charges, dipoles, nt, targ, pottarg, 1, 1, 1, 1, 3, ns, nd, ns, nd3, ns, 1, 3, nt, nd, nt);
    ...
    if(pgt == 2)
      if(ifcharge==1 && ifdipole == 0)
        mex_id_ = 'hfmm3dpartstotcg_vec(i int[x], i double[x], i dcomplex[x], i int[x], i double[xx], i dcomplex[xx], i int[x], i double[xx], io dcomplex[xx], io dcomplex[xx])';
[pottarg, gradtarg] = fmm3d(mex_id_, nd, eps, zk, ns, sources, charges, nt, targ, pottarg, gradtarg, 1, 1, 1, 1, 3, ns, nd, ns, 1, 3, nt, nd, nt, nd3, nt);
      ...
      if(ifcharge==0 && ifdipole == 1)
        mex_id_ = 'hfmm3dpartstotdg_vec(i int[x], i double[x], i dcomplex[x], i int[x], i double[xx], i dcomplex[xx], i int[x], i double[xx], io dcomplex[xx], io dcomplex[xx])';
[pottarg, gradtarg] = fmm3d(mex_id_, nd, eps, zk, ns, sources, dipoles, nt, targ, pottarg, gradtarg, 1, 1, 1, 1, 3, ns, nd3, ns, 1, 3, nt, nd, nt, nd3, nt);
      ...
      if(ifcharge==1 && ifdipole == 1)
        mex_id_ = 'hfmm3dpartstotcdg_vec(i int[x], i double[x], i dcomplex[x], i int[x], i double[xx], i dcomplex[xx], i dcomplex[xx], i int[x], i double[xx], io dcomplex[xx], io dcomplex[xx])';
[pottarg, gradtarg] = fmm3d(mex_id_, nd, eps, zk, ns, sources, charges, dipoles, nt, targ, pottarg, gradtarg, 1, 1, 1, 1, 3, ns, nd, ns, nd3, ns, 1, 3, nt, nd, nt, nd3, nt);
  ...
  if(iftarg == 1 && (pg ==1 || pg ==2))
    ...
    if(pgt == 1)
      if(ifcharge==1 && ifdipole == 0)
        mex_id_ = 'hfmm3dpartstostcp_vec(i int[x], i double[x], i dcomplex[x], i int[x], i double[xx], i dcomplex[xx], io dcomplex[xx], i int[x], i double[xx], io dcomplex[xx])';
[pot, pottarg] = fmm3d(mex_id_, nd, eps, zk, ns, sources, charges, pot, nt, targ, pottarg, 1, 1, 1, 1, 3, ns, nd, ns, nd, ns, 1, 3, nt, nd, nt);
      end
      if(ifcharge==0 && ifdipole == 1)
        mex_id_ = 'hfmm3dpartstostdp_vec(i int[x], i double[x], i dcomplex[x], i int[x], i double[xx], i dcomplex[xx], io dcomplex[xx], i int[x], i double[xx], io dcomplex[xx])';
[pot, pottarg] = fmm3d(mex_id_, nd, eps, zk, ns, sources, dipoles, pot, nt, targ, pottarg, 1, 1, 1, 1, 3, ns, nd3, ns, nd, ns, 1, 3, nt, nd, nt);
      end
      if(ifcharge==1 && ifdipole == 1)
        mex_id_ = 'hfmm3dpartstostcdp_vec(i int[x], i double[x], i dcomplex[x], i int[x], i double[xx], i dcomplex[xx], i dcomplex[xx], io dcomplex[xx], i int[x], i double[xx], io dcomplex[xx])';
[pot, pottarg] = fmm3d(mex_id_, nd, eps, zk, ns, sources, charges, dipoles, pot, nt, targ, pottarg, 1, 1, 1, 1, 3, ns, nd, ns, nd3, ns, nd, ns, 1, 3, nt, nd, nt);
    ...
    if(pgt == 2)
      if(ifcharge==1 && ifdipole == 0)
        mex_id_ = 'hfmm3dpartstostcg_vec(i int[x], i double[x], i dcomplex[x], i int[x], i double[xx], i dcomplex[xx], io dcomplex[xx], io dcomplex[xx], i int[x], i double[xx], io dcomplex[xx], io dcomplex[xx])';
[pot, grad, pottarg, gradtarg] = fmm3d(mex_id_, nd, eps, zk, ns, sources, charges, pot, grad, nt, targ, pottarg, gradtarg, 1, 1, 1, 1, 3, ns, nd, ns, nd, ns, nd3, ns, 1, 3, nt, nd, nt, nd3, nt);
      ...
      if(ifcharge==0 && ifdipole == 1)
        mex_id_ = 'hfmm3dpartstostdg_vec(i int[x], i double[x], i dcomplex[x], i int[x], i double[xx], i dcomplex[xx], io dcomplex[xx], io dcomplex[xx], i int[x], i double[xx], io dcomplex[xx], io dcomplex[xx])';
[pot, grad, pottarg, gradtarg] = fmm3d(mex_id_, nd, eps, zk, ns, sources, dipoles, pot, grad, nt, targ, pottarg, gradtarg, 1, 1, 1, 1, 3, ns, nd3, ns, nd, ns, nd3, ns, 1, 3, nt, nd, nt, nd3, nt);
      ...
      if(ifcharge==1 && ifdipole == 1)
        mex_id_ = 'hfmm3dpartstostcdg_vec(i int[x], i double[x], i dcomplex[x], i int[x], i double[xx], i dcomplex[xx], i dcomplex[xx], io dcomplex[xx], io dcomplex[xx], i int[x], i double[xx], io dcomplex[xx], io dcomplex[xx])';

...
% See also: L3DDIR
  ...
  ndiv = 400;
  idivflag = 0;
  mex_id_ = 'lndiv(c i double[x], c i int64_t[x], c i int64_t[x], c i int64_t[x], c i int64_t[x], c i int64_t[x], c i int64_t[x], c io int64_t[x], c io int64_t[x])';
[ndiv, idivflag] = fmm3d(mex_id_, eps, ns, nt, ifcharge, ifdipole, pg, pgt, ndiv, idivflag, 1, 1, 1, 1, 1, 1, 1, 1, 1);
  ...
  iper = 1;
  timeinfo = zeros(6,1);
  mex_id_ = 'lfmm3d_ndiv(c i int64_t[x], c i double[x], c i int64_t[x], c i double[xx], c i int64_t[x], c i double[xx], c i int64_t[x], c i double[xx], c i int64_t[x], c i int64_t[x], c io double[xx], c io double[xx], c io double[xx], c i int64_t[x], c i double[xx], c i int64_t[x], c io double[xx], c io double[xx], c io double[xx], c i int64_t[x], c i int64_t[x], c i int64_t[x], c io double[x], c io int64_t[x])';

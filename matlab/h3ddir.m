...
% See also: HFMM3D
  ...
  if(pgt == 1)
    if(ifcharge==1 && ifdipole == 0)
      mex_id_ = 'h3ddirectcp(c i int64_t[x], c i dcomplex[x], c i double[xx], c i dcomplex[xx], c i int64_t[x], c i double[xx], c i int64_t[x], c io dcomplex[xx], c i double[x])';
[pottarg] = fmm3d(mex_id_, nd, zk, sources, charges, ns, targ, nt, pottarg, thresh, 1, 1, 3, ns, nd, ns, 1, 3, nt, 1, nd, nt, 1);
    ...
    if(ifcharge==0 && ifdipole == 1)
      mex_id_ = 'h3ddirectdp(c i int64_t[x], c i dcomplex[x], c i double[xx], c i dcomplex[xx], c i int64_t[x], c i double[xx], c i int64_t[x], c io dcomplex[xx], c i double[x])';
[pottarg] = fmm3d(mex_id_, nd, zk, sources, dipoles, ns, targ, nt, pottarg, thresh, 1, 1, 3, ns, nd3, ns, 1, 3, nt, 1, nd, nt, 1);
    ...
    if(ifcharge==1 && ifdipole == 1)
      mex_id_ = 'h3ddirectcdp(c i int64_t[x], c i dcomplex[x], c i double[xx], c i dcomplex[xx], c i dcomplex[xx], c i int64_t[x], c i double[xx], c i int64_t[x], c io dcomplex[xx], c i double[x])';
[pottarg] = fmm3d(mex_id_, nd, zk, sources, charges, dipoles, ns, targ, nt, pottarg, thresh, 1, 1, 3, ns, nd, ns, nd3, ns, 1, 3, nt, 1, nd, nt, 1);
  ...
  if(pgt == 2)
    if(ifcharge==1 && ifdipole == 0)
      mex_id_ = 'h3ddirectcg(c i int64_t[x], c i dcomplex[x], c i double[xx], c i dcomplex[xx], c i int64_t[x], c i double[xx], c i int64_t[x], c io dcomplex[xx], c io dcomplex[xx], c i double[x])';
[pottarg, gradtarg] = fmm3d(mex_id_, nd, zk, sources, charges, ns, targ, nt, pottarg, gradtarg, thresh, 1, 1, 3, ns, nd, ns, 1, 3, nt, 1, nd, nt, nd3, nt, 1);
    ...
    if(ifcharge==0 && ifdipole == 1)
      mex_id_ = 'h3ddirectdg(c i int64_t[x], c i dcomplex[x], c i double[xx], c i dcomplex[xx], c i int64_t[x], c i double[xx], c i int64_t[x], c io dcomplex[xx], c io dcomplex[xx], c i double[x])';
[pottarg, gradtarg] = fmm3d(mex_id_, nd, zk, sources, dipoles, ns, targ, nt, pottarg, gradtarg, thresh, 1, 1, 3, ns, nd3, ns, 1, 3, nt, 1, nd, nt, nd3, nt, 1);
    ...
    if(ifcharge==1 && ifdipole == 1)
      mex_id_ = 'h3ddirectcdg(c i int64_t[x], c i dcomplex[x], c i double[xx], c i dcomplex[xx], c i dcomplex[xx], c i int64_t[x], c i double[xx], c i int64_t[x], c io dcomplex[xx], c io dcomplex[xx], c i double[x])';

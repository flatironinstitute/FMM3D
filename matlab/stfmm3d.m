...
% See also: ST3DDIR
  ...
  mex_id_ = 'stfmm3d(c i int64_t[x], c i double[x], c i int64_t[x], c i double[xx], c i int64_t[x], c i double[xx], c i int64_t[x], c i double[xx], c i double[xx], c i int64_t[x], c i double[xx], c i double[xx], c i int64_t[x], c i double[xx], c i double[xx], c i int64_t[x], c io double[xx], c io double[xx], c io double[xx], c i int64_t[x], c i double[xx], c i int64_t[x], c io double[xx], c io double[xx], c io double[xx], c io int64_t[x])';

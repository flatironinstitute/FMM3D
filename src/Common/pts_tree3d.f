...
c
      ...
      implicit none
      integer, intent(in) :: ns, nt, idivflag, ndiv, nlmin, nlmax
      integer, intent(in) :: ifunif, iper
      integer, intent(out) :: nboxes, nlevels
...
c
      implicit none
      integer, intent(in) :: ns, nt, idivflag, ndiv, nlmin, nlmax
      integer, intent(in) :: ifunif, iper, nlevels, nboxes
